...
<!--        <link rel="stylesheet" href="//<?php //echo base_url() ?>assets/adminlte/http/font-awesome.min.css">-->
        <link rel="stylesheet" href="<?php //echo base_url() ?>assets/adminlte/bootstrap/css/font-awesome.min.css">
        <!-- Ionicons -->
        <!--            <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">-->
        <!--            <link rel="stylesheet" href="<?php //echo base_url()  ?>assets/adminlte/http/ionicons.min.css">-->
...
<!--        <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">-->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- jQuery UI 1.11.4 -->
        <script type="text/javascript" src="<?php echo base_url() ?>assets/adminlte/http/jquery-ui.min.js"></script>
    ...
    <!--    <script type="text/javascript" src="<?php //echo base_url()     ?>assets/adminlte/http/raphael-min.js"></script>-->
    ...
    <!--    <script type="text/javascript" src="<?php //echo base_url()     ?>assets/adminlte/http/moment.min.js"></script>-->
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>assets/adminlte/dist/js/pages/dashboard.js"></script>
        <!-- AdminLTE for demo purposes -->
        <script type="text/javascript" src="<?php echo base_url() ?>assets/adminlte/dist/js/demo.js"></script>
    </body>
</html>
