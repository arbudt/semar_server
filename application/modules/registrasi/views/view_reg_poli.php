        ...
        <div class="row-fluid">
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="datePickerTanggal" class="input-append date">
                                <input class="input input-small tanggal" data-format="dd-MM-yyyy" type="text" name="tanggalLahir" id="tanggalLahir" value="<?php echo tglSekarang(); ?>" readonly>
                                <span class="add-on">
            ...
            <div class="span6">
                <table>
                    ...
                    <tr>
                        <td class="labelField">Rumah Sakit</td>
                        <td>
                            <select disabled>
                                <option value="">...</option>
                                <option value="">RSUD Jogja</option>
                                <option value="">PKU Muhammadiyah</option>
                                <option value="">RSUP Sardjito</option>
                            </select><?php //dropDownPoli('name="poli" id="poli" class="poli" required');   ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="datePickerTanggalPeriksa" class="input-append date">
                                <input class="input input-small tanggal" data-format="dd-MM-yyyy" type="text" name="tanggalPeriksa" id="tanggalPeriksa" value="<?php echo tglSekarang(); ?>" readonly>
                                <span class="add-on">
                                    <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                </span>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <select disabled name="dokter" id="dokter" class="dokter" disabled=""><option value="">...</option><option value="1">Dr Budi Santosa </option><option value="2">Dr Santi Wati </option><option value="3">Dr Hasan As Ari </option><option value="4">Dr Listy Ningsih </option></select>
                            <?php //dropDownDokter('name="dokter" id="dokter" class="dokter"'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="labelField">Cara Bayar</td>
                        <td>
                            <select disabled name="caraBayar" id="caraBayar" class="caraBayar" required="" disabled=""><option value="">...</option><option value="1">Umum</option><option value="2">Jamkesmas</option><option value="3">Jamkesda</option><option value="4">Asuransi</option></select>
                            <?php //dropDownCaraBayar('name="caraBayar" id="caraBayar" class="caraBayar" required'); ?></td>
                    </tr>
                    <tr>
