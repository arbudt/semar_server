...
HandsontableDateEditorClass.prototype.createElements = function () {
  ...
  this.datePickerStyle.zIndex = 1101;
...
HandsontableDateEditorClass.prototype.beginEditing = function (row, col, prop, useOriginalValue, suffix) {
  // by nanda for masking date input
  this.$textarea.mask(this.cellProperties.dateFormat.replace('yy','yyyy').replace(/[a-zA-Z]/g, '9')).select();
...
HandsontableDateEditorClass.prototype.finishEditing = function (isCancelled, ctrlDown) {
  this.hideDatepicker();
  HandsontableTextEditorClass.prototype.finishEditing.call(this, isCancelled, ctrlDown);
  var regextest = /^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$/;
  // if (!regextest.test(this.originalValue)) {
  //   this.TD.className += ' htInvalid';
  // };
};
...
(function () {
    ...
    ************************************/
    ...
    // hooks js by nanda7anku@gmail.com for ID localization
    numeral.language('id', {
        delimiters: {
            thousands: '.',
            decimal: ','
