...
var bootbox = window.bootbox || (function(document, $) {
    ...
    that.dialog = function(str, handlers, options) {
        ...
        if(typeof options.headerTitle!='undefined'){
            parts.push("<div class='modal-header "+options.headerClass+"'><button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button><h3>"+options.headerTitle+"</h3></div>");
        }
