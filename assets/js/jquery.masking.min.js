...
c),b.moveStart("character",c),b.select())},events:function(){a.on("keydown.masking",function(){n=f.val()});a.on("keyup.masking",f.behaviour);a.on("paste.masking",function(){setTimeout(function(){a.keydown().keyup()},100)})},destroyEvents:function(){a.off("keydown.masking").off("keyup.masking").off("paste.masking")},val:function(c){var b="input"===a.get(0).tagName.toLowerCase();return 0<arguments.length?b?a.val(c):a.text(c):b?a.val():a.text()},behaviour:function(c){c=c||window.event;if(-1===h.inArray(c.keyCode||c.which,
...
a.push(b.charAt(d));return a.join("")};k.init()};h.fn.masking=function(a,g){return this.each(function(){h(this).data("masking",new w(this,a,g))})};h.fn.unmasking=function(){return this.each(function(){try{h(this).data("masking").remove()}catch(a){}})};h("input[data-masking]").each(function(){var a=h(this),g={};"true"===a.attr("data-masking-reverse")&&(g.reverse=!0);"false"===a.attr("data-masking-maxlength")&&(g.maxlength=!1);a.masking(a.attr("data-masking"),g)})})(window.jQuery||window.Zepto);
