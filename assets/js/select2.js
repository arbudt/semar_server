...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Minimal " + n + " karakter" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Hapus" + n + " karakter" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "Hanya dapat memilih " + limit + " item" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Pencarian..."; },
        formatSearching: function () { return "Pencarian..."; },
